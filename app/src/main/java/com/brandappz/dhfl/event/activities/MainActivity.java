...
import com.brandappz.dhfl.event.constants.NavigationPositions;
import com.brandappz.dhfl.event.fragments.AbstractFragment;
import com.brandappz.dhfl.event.fragments.HomeFragment;
import com.brandappz.dhfl.event.fragments.OrganizingCommitteeFragment;
import com.brandappz.dhfl.event.fragments.GalleryFragment;
import com.brandappz.dhfl.event.fragments.HotelFragment;
import com.brandappz.dhfl.event.fragments.QuizFragment;
import com.brandappz.dhfl.event.fragments.QuizLeaderBoard;
import com.brandappz.dhfl.event.fragments.SpeakersFragment;
import com.brandappz.dhfl.event.fragments.SupportFragment;
import com.brandappz.dhfl.event.fragments.TabmolaFragment;
import com.brandappz.dhfl.event.fragments.VideoFragment;
import com.brandappz.dhfl.event.helper.PrefManager;
import com.brandappz.dhfl.event.pushbotsHandler;
    ...
    public void positions(int position) {
        ...
        switch (position) {
            ...
            case 3:
                ...
                break;
            case 4:
                menuicon.setBackgroundResource(R.drawable.menu5);
...
*/
            case 5:
                menuicon.setBackgroundResource(R.drawable.menu4);
                ...
                break;
            case 6:
                menuicon.setBackgroundResource(R.drawable.menu8);
                content = new Flightframent();
                htitle.setText("Travel Advisory");
                break;
            case 7:
                menuicon.setBackgroundResource(R.drawable.menu2);
                content = new QuizFragment();
                htitle.setText("Quiz");
                break;
            case 8:
