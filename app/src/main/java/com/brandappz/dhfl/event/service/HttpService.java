package com.brandappz.dhfl.event.service;
...
import static com.brandappz.dhfl.event.activities.Config.REGISTER_URL;

/**
 * Created by Ankit on 09-03-2017.
 */
...
public class HttpService extends IntentService {
    ...
    private void verifyOtp(final String otp){
        ...
        ConferenceApp.getInstance().addToRequestQueue(strReq);
    }
}
